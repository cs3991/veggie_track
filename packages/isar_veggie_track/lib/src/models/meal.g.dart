...
const MealSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'foodType': LinkSchema(
      id: -9124957139596693480,
      name: r'foodType',
      target: r'FoodType',
      single: true,
    )
...
void _mealSerialize(
  ...
  writer.writeByte(offsets[1], object.mealType.index);
...
void _mealAttach(IsarCollection<dynamic> col, Id id, Meal object) {
  object.id = id;
  object.foodType.attach(col, col.isar.collection<FoodType>(), r'foodType', id);
}
...
extension MealQueryLinks on QueryBuilder<Meal, Meal, QFilterCondition> {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> foodTypeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'foodType', 0, true, 0, true);
    });
  }
}
